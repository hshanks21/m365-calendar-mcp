...
No running-service restart, registry push, tag, CI workflow or live-provider request is performed by these credential-free build instructions. Future automation must follow [MCP_DEPLOYMENT_STANDARD.md](MCP_DEPLOYMENT_STANDARD.md) and [../RELEASING.md](../RELEASING.md).
